      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleTheme}
              className="w-9 h-9 rounded-lg flex items-center justify-center dark:text-white/40 text-gray-400 hover:dark:text-white hover:text-gray-700 dark:hover:bg-white/[0.05] hover:bg-gray-100 transition-all"
